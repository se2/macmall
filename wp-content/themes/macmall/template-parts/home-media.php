...
?>
	<section class="home-media flex flex-wrap overflow-x-hidden py-5">
		<a href="<?php echo esc_url( $link['url'] ); ?>" target="<?php echo esc_attr( $link['target'] ); ?>" class="block w-full lg:<?php the_sub_field( 'layout' ); ?> <?php echo ( get_sub_field( 'layout' ) == 'w-1/2' ) ? 'lg:pr-5' : ''; ?>">
		...
		?>
		<a href="<?php echo esc_url( $link_2['url'] ); ?>" target="<?php echo esc_attr( $link_2['target'] ); ?>" class="block w-full lg:<?php the_sub_field( 'layout' ); ?> lg:pl-5">
